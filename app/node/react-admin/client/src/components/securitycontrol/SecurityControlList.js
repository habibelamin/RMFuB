...
import {List, ShowButton, Datagrid, TextField, ReferenceManyField, SingleFieldList,ChipField,ReferenceField,  EditButton, DeleteButton} from 'react-admin'
const SecurityControlList = (props) => {
    return <List {...props}>
        <Datagrid>
            <TextField source ='id'/>
            <TextField source ='sname' label='Name'/>
            {/* <TextField source ='mdid'/> */}
            {/* <TextField source ='supid'/> */}
            ...
            <ShowButton basePath='/securitycontrols' />
            <EditButton basePath='/securitycontrols' />
            <DeleteButton basePath ='/securitycontrols'/>
        </Datagrid>
